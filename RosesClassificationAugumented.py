...
# partitioning the feature map into a set of non-overlapping
# rectangular regions, called pooling windows, and for each window,
# selecting the maximum value within that window.   
  layers.MaxPooling2D(),
  ...
  # reduce dimensionality from multifeatures into one dimensional array
  layers.Flatten(),
